...
`define	SEEK_END 2
	...
	*/
	...
	integer data_offset;
	always @( x_pos_ddr or y_pos_ddr )
	begin
		data_offset	 = (y_pos_ddr * 32 * US * US + x_pos_ddr * US)*FW/8;
	end
	...
	*/
	...
	generate
		...
		begin
			if( reg_matrix_full == 2'b01 || reg_matrix_full == 2'b10 )
				$fdisplay( file_result_id, "x_position(%d)----y_position(%d)", x_pos_ddr, y_pos_ddr );
		end
