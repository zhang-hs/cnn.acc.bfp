...
module top;
	...
	begin
		...
		begin
			...
			begin
                ...
                else if( _wr_count == 8'd2 )
                begin
				    count = $fread(data01,fd_data); char_count = char_count + count;
                    data02 = {(EXP+MAN+1){1'b1}};
                    data03 = {(EXP+MAN+1){1'b1}};
                    data04 = {(EXP+MAN+1){1'b1}};
                    data05 = {(EXP+MAN+1){1'b1}};
                    data06 = {(EXP+MAN+1){1'b1}};
                    data07 = {(EXP+MAN+1){1'b1}};
                    data08 = {(EXP+MAN+1){1'b1}};
                    data09 = {(EXP+MAN+1){1'b1}};
                    data10 = {(EXP+MAN+1){1'b1}};
                    data11 = {(EXP+MAN+1){1'b1}};
                    data12 = {(EXP+MAN+1){1'b1}};
                    data13 = {(EXP+MAN+1){1'b1}};
                    data14 = {(EXP+MAN+1){1'b1}};
                    data15 = {(EXP+MAN+1){1'b1}};
                    data16 = {(EXP+MAN+1){1'b1}};
                end
			end
	...
	localparam WR_END_ADDR = 30'h18000; // (fm_width*fm_height)*float_num_bit/ddr_data_width - ddr_burst_size
	...
	begin
		...
		begin
			...
			begin
                ...
                _wr_count <= _wr_count + 8'd1;
			end
            if( _wr_count == 8'd3 && _next_wr == 1'b1 )
            begin
                _wr_count <= 8'd0;
            end
    ...
    */
	...
	always@(posedge ddr_clk or negedge sys_rst_n) begin
	  ...
	  */
	  if((rd_ddr_x_proc==30) && (rd_ddr_y_proc==30) && (cnn_conv_output_last == 1'b1) &&
