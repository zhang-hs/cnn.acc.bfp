...
module top;
	...
	*/
	...
	always @( x_pos_ddr or y_pos_ddr or feature_index )
	begin
		...
		data_offset	 = (y_pos_ddr_delay * 32 * US * US + (x_pos_ddr_delay) * US)*FW/8;
	end
	...
	begin
		...
		begin
			...
			feature_in_data_check( data_offset, x_pos_ddr_delay, y_pos_ddr_delay, feature_index_delay, test_data_reg );	
	...
	*/
	...
	always@(posedge ddr_clk or negedge sys_rst_n) begin
	  ...
	  */
	  if((x_pos_ddr==2) && (y_pos_ddr==0)) begin
		#20 $finish;
	  end
	end
