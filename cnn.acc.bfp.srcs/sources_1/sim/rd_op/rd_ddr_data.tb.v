...
module top_rd_ddr_data(
  ...
  wire [4:0]        _rd_data_data_grp;
  wire              _rd_data_data_valid;
  wire              _rd_data_full;
  reg  [3:0]        _rd_data_data_x;
  reg  [3:0]        _rd_data_data_y;
  wire              _rd_data_data_x_eq_end;
  wire              _rd_data_data_y_eq_end;
  //mem_top
  ...
  rd_ddr_data rd_ddr_data_u(
    ...
    .rd_data_grp(_rd_data_data_grp),
    .rd_data_data_x(_rd_data_data_x),
    .rd_data_data_y(_rd_data_data_y),
//    .rd_data_data_x_eq_end(_rd_data_data_x_eq_end),
//    .rd_data_data_y_eq_end(_rd_data_data_y_eq_end),
    .rd_data_valid(_rd_data_data_valid),
...
//    .mem_top_rd_ddr_data_addr(_rd_data_addr_reg),//for debug
    .mem_top_rd_ddr_data_grp(_rd_data_data_grp),
    .mem_top_rd_ddr_data_valid(_rd_data_data_valid),
    .mem_top_rd_ddr_data_x(_rd_data_data_x),
    .mem_top_rd_ddr_data_y(_rd_data_data_y),
//    .mem_top_rd_ddr_data_x_eq_end(_rd_data_data_x_eq_end),
//    .mem_top_rd_ddr_data_y_eq_end(_rd_data_data_y_eq_end),
    .mem_top_rd_ddr_data_ith_fm(_ithFM),
    .mem_top_rd_ddr_data_bottom_fm_width(8'd224),
