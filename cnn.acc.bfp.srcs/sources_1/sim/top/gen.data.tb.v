...
// File       : gen_data.tb.v
//
// Description: generate bottom data used in rd_ddr_op_tb.v
//              224*224*3
//
// Version    : 1.0
// ---------------------------------------------------
...
module top;
  ...
  initial begin
    fd_result = $fopen("data.tb.bin","wb");
    data_count = 0;
    int_cnt = 0;
  ...
  always@(posedge ddr_clk or negedge sys_rst_n) begin
    if(sys_rst_n) begin
      if(data04[7:0] == 8'hc3) begin // last entry of 14x14
        if(data04[19:8] == 20'h0ff) begin
          data01 <= {data01[31:24],24'b0} + 32'h1000000; data02 <= {data02[31:24],24'b0} + 32'h1000001;
          data03 <= {data03[31:24],24'b0} + 32'h1000002; data04 <= {data04[31:24],24'b0} + 32'h1000003;
          data05 <= {data05[31:24],24'b0} + 32'h1000004; data06 <= {data06[31:24],24'b0} + 32'h1000005;
          data07 <= {data07[31:24],24'b0} + 32'h1000006; data08 <= {data08[31:24],24'b0} + 32'h1000007;
          data09 <= {data09[31:24],24'b0} + 32'h1000008; data10 <= {data10[31:24],24'b0} + 32'h1000009;
          data11 <= {data11[31:24],24'b0} + 32'h100000a; data12 <= {data12[31:24],24'b0} + 32'h100000b;
          data13 <= {data13[31:24],24'b0} + 32'h100000c; data14 <= {data14[31:24],24'b0} + 32'h100000d;
          data15 <= {data15[31:24],24'b0} + 32'h100000e; data16 <= {data16[31:24],24'b0} + 32'h100000f;
        end else begin
          data01 <= {data01[31:08],8'b0} + 32'h100; data02 <= {data02[31:08],8'b0} + 32'h101;
          data03 <= {data03[31:08],8'b0} + 32'h102; data04 <= {data04[31:08],8'b0} + 32'h103;
          data05 <= {data05[31:08],8'b0} + 32'h104; data06 <= {data06[31:08],8'b0} + 32'h105;
          data07 <= {data07[31:08],8'b0} + 32'h106; data08 <= {data08[31:08],8'b0} + 32'h107;
          data09 <= {data09[31:08],8'b0} + 32'h108; data10 <= {data10[31:08],8'b0} + 32'h109;
          data11 <= {data11[31:08],8'b0} + 32'h10a; data12 <= {data12[31:08],8'b0} + 32'h10b;
          data13 <= {data13[31:08],8'b0} + 32'h10c; data14 <= {data14[31:08],8'b0} + 32'h10d;
          data15 <= {data15[31:08],8'b0} + 32'h10e; data16 <= {data16[31:08],8'b0} + 32'h10f;
        end
      end else begin
      ...
      if(data04[7:0] == 8'hc3) begin // write out last 4 element
      `ifdef usingDirectC
      ...
      `endif
        ...
        int_cnt <= int_cnt + 1;
        $display("%t: int_cnt: %d, data_count: %d", $realtime, int_cnt, data_count);
      end else begin
      `ifdef usingDirectC
        $fwrite(fd_result, "%c%c%c%c", data01[7:0],data01[15:8],data01[23:16],data01[31:24]);
        $fwrite(fd_result, "%c%c%c%c", data02[7:0],data02[15:8],data02[23:16],data02[31:24]);
      ...
      `endif
        data_count <= data_count + 5'd16;
      end
      if(data_count == 150528-4) begin // 3 feature map: 150528
        $display("%t: int_cnt: %d", $realtime, int_cnt);
        $finish;
      end
    end
  end
