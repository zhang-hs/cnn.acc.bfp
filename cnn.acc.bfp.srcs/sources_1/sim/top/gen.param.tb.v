...
// File       : gen_param.tb.v
//
// Description: generate param data used in rd_ddr_op_tb.v
//
// Version    : 1.0
// ---------------------------------------------------
...
module top;
  ...
  initial begin
    fd_result = $fopen("param.tb.bin","wb");
    data_count = 0;
  ...
  always@(posedge ddr_clk or negedge sys_rst_n) begin
    if(sys_rst_n) begin
      if(data01[23:0] == 24'd48) begin // bias_num - 16
        data01 <= {data01[31:24],24'b0} + 32'h10000; data02 <= {data02[31:24],24'b0} + 32'h10001;
        data03 <= {data03[31:24],24'b0} + 32'h10002; data04 <= {data04[31:24],24'b0} + 32'h10003;
        data05 <= {data05[31:24],24'b0} + 32'h10004; data06 <= {data06[31:24],24'b0} + 32'h10005;
        data07 <= {data07[31:24],24'b0} + 32'h10006; data08 <= {data08[31:24],24'b0} + 32'h10007;
        data09 <= {data09[31:24],24'b0} + 32'h10008; data10 <= {data10[31:24],24'b0} + 32'h10009;
        data11 <= {data11[31:24],24'b0} + 32'h1000a; data12 <= {data12[31:24],24'b0} + 32'h1000b;
        data13 <= {data13[31:24],24'b0} + 32'h1000c; data14 <= {data14[31:24],24'b0} + 32'h1000d;
        data15 <= {data15[31:24],24'b0} + 32'h1000e; data16 <= {data16[31:24],24'b0} + 32'h1000f;
        bias_done <= 1'b1;
      end else if((data01[15:0]==16'h110) && bias_done) begin // kernel
    ...
    //end
    //data_count <= data_count+5'd1;
      if(data_count == ((BIAS_NUM+KER_SET_NUM*KER_SET_SIZE)/16-1)) begin
