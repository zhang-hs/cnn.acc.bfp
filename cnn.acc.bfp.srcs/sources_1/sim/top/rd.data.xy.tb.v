...
module top;
  ...
  initial begin
    fd_data = $fopen("../../data/c.gen.bottom.tb.v.1.11.bin","rb");
    char_count = 0;
    data_count = 0;
  ...
  localparam WR_END_ADDR = 30'h61f8; // (fm_width*fm_height)*float_num_bit/ddr_data_width - ddr_burst_size
  ...
  rd_ddr_data rd_data(
      ...
      .rd_data_bar_offset(32'h800), // 7*7*4*num_of_atom_in_1_bar*float_num_width/ddr_data_width -> 64*4*num_of_atom_in_1_bar*float_num_width/ddr_data_width
      .rd_data_data(rd_data_data),
      .rd_data_num_valid(),
      .rd_data_valid(rd_data_valid),

      .rd_data_bottom_addr(30'h0),// read bottom data address, start address of bottom data
      .rd_data_half_bar_offset(30'h400), // 7*7*2*num_of_atom_in_1_bar*float_num_width/ddr_data_width -> 64*2*num_of_atom_in_1_bar*float_num_width/ddr_data_width
      .rd_data_patch_valid_last(),
      .rd_data_valid_first(),
  ...
  always@(posedge ddr_clk or negedge sys_rst_n) begin
    ...
    if((rd_data_x==ENDOFX) && (rd_data_y==2)) begin
      $finish;
    end
  end
