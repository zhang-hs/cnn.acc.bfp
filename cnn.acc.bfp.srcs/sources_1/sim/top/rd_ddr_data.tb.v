...
//    if(tb_load_done) begin
//      if(rd_data_full || loadingDone) begin
//        readControl(loadingDone, rd_data_full, readBottomData, bottomDataAddr,
//                    ENDOFX, ENDOFY, xPos, yPos, isFirstFM, ithOffset, barOffset, ithFM, readEnd);
//      end else begin
//        readBottomData <= 1'b0;
//      end
//    end
//    if(xPos==ENDOFX && (yPos==3)) begin
//      $finish;
//    end
//  end
//end
...
//      rd_data_bottom <= 1'b0;
//    end
//    readProcRam(fd_data, rd_data_bottom, rd_data_x, rd_data_y, ENDOFX, ENDOFY, 30'h620, 30'h0, procRAM);
//  end
