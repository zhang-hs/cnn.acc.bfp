// ---------------------------------------------------
// File       : rd.data.00.tb.v
//
// Description: read bottom data on (0,0) from ddr
//
// Version    : 1.0
// ---------------------------------------------------
...
module top;
  ...
  rd_ddr_data rd_data(
      ...
      .rd_data_bottom(tb_load_done),
      .rd_data_end_of_x(9'h10),
      .rd_data_end_of_y(9'h10),
      .rd_data_x(9'h0),
      .rd_data_y(9'h0),
