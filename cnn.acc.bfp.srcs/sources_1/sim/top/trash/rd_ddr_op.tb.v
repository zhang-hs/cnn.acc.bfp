// read ddr operation simulation top module
...
module rd_ddr_op_tb;
  ...
  initial begin
    ...
    // feeding data
    /*
    count = $fread(data01, fd_data);
    char_count = char_count + count;
    count = $fread(data02, fd_data);
    char_count = char_count + count;
    count = $fread(data03, fd_data);
    char_count = char_count + count;
    count = $fread(data04, fd_data);
    char_count = char_count + count;
    count = $fread(data05, fd_data);
    char_count = char_count + count;
    count = $fread(data06, fd_data);
    char_count = char_count + count;
    count = $fread(data07, fd_data);
    char_count = char_count + count;
    count = $fread(data08, fd_data);
    char_count = char_count + count;
    count = $fread(data09, fd_data);
    char_count = char_count + count;
    count = $fread(data10, fd_data);
    char_count = char_count + count;
    count = $fread(data11, fd_data);
    char_count = char_count + count;
    count = $fread(data12, fd_data);
    char_count = char_count + count;
    count = $fread(data13, fd_data);
    char_count = char_count + count;
    count = $fread(data14, fd_data);
    char_count = char_count + count;
    count = $fread(data15, fd_data);
    char_count = char_count + count;
    count = $fread(data16, fd_data);
    char_count = char_count + count;
  ...
  localparam WR_END_ADDR = 29'd1000;
  localparam RD_END_ADDR = 29'd1000;
  ...
  always@(posedge ddr_clk) begin
    if(sync_rst) begin
      ...
      if(_next_rd) begin
        _rd_addr <= _rd_addr + RD_ADDR_STRIDE;
        $display("%t: read data from addr: %d", $realtime, _rd_addr);
      end
    end
    if(_rd_addr == RD_END_ADDR)
      $finish;
