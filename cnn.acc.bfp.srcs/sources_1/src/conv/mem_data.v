...
//  (*mark_debug="TRUE"*) wire[MID_WIDTH-1:0] _mem_data_max_o_h;
//  assign _mem_data_max_o_h = _mem_data_max_o[MID_WIDTH-1:0];
...
//  (*mark_debug="TRUE"*) wire[MID_WIDTH-1:0] _mem_data_data_h;
//  assign _mem_data_data_h = _mem_data_data[MID_WIDTH-1:0];
...
//  reg                                     _mem_fm_max_exp_o_valid;
  ...
  always@(posedge clk) begin
    if(mem_bias_exp_valid) begin
      {_mem_bias_exp[_mem_bias_exp_offset+63],_mem_bias_exp[_mem_bias_exp_offset+62],_mem_bias_exp[_mem_bias_exp_offset+61],_mem_bias_exp[_mem_bias_exp_offset+60],
       _mem_bias_exp[_mem_bias_exp_offset+59],_mem_bias_exp[_mem_bias_exp_offset+58],_mem_bias_exp[_mem_bias_exp_offset+57],_mem_bias_exp[_mem_bias_exp_offset+56],
       _mem_bias_exp[_mem_bias_exp_offset+55],_mem_bias_exp[_mem_bias_exp_offset+54],_mem_bias_exp[_mem_bias_exp_offset+53],_mem_bias_exp[_mem_bias_exp_offset+52],
       _mem_bias_exp[_mem_bias_exp_offset+51],_mem_bias_exp[_mem_bias_exp_offset+50],_mem_bias_exp[_mem_bias_exp_offset+49],_mem_bias_exp[_mem_bias_exp_offset+48],
       _mem_bias_exp[_mem_bias_exp_offset+47],_mem_bias_exp[_mem_bias_exp_offset+46],_mem_bias_exp[_mem_bias_exp_offset+45],_mem_bias_exp[_mem_bias_exp_offset+44],
       _mem_bias_exp[_mem_bias_exp_offset+43],_mem_bias_exp[_mem_bias_exp_offset+42],_mem_bias_exp[_mem_bias_exp_offset+41],_mem_bias_exp[_mem_bias_exp_offset+40],
       _mem_bias_exp[_mem_bias_exp_offset+39],_mem_bias_exp[_mem_bias_exp_offset+38],_mem_bias_exp[_mem_bias_exp_offset+37],_mem_bias_exp[_mem_bias_exp_offset+36],
       _mem_bias_exp[_mem_bias_exp_offset+35],_mem_bias_exp[_mem_bias_exp_offset+34],_mem_bias_exp[_mem_bias_exp_offset+33],_mem_bias_exp[_mem_bias_exp_offset+32],
       _mem_bias_exp[_mem_bias_exp_offset+31],_mem_bias_exp[_mem_bias_exp_offset+30],_mem_bias_exp[_mem_bias_exp_offset+29],_mem_bias_exp[_mem_bias_exp_offset+28],
       _mem_bias_exp[_mem_bias_exp_offset+27],_mem_bias_exp[_mem_bias_exp_offset+26],_mem_bias_exp[_mem_bias_exp_offset+25],_mem_bias_exp[_mem_bias_exp_offset+24],
       _mem_bias_exp[_mem_bias_exp_offset+23],_mem_bias_exp[_mem_bias_exp_offset+22],_mem_bias_exp[_mem_bias_exp_offset+21],_mem_bias_exp[_mem_bias_exp_offset+20],
       _mem_bias_exp[_mem_bias_exp_offset+19],_mem_bias_exp[_mem_bias_exp_offset+18],_mem_bias_exp[_mem_bias_exp_offset+17],_mem_bias_exp[_mem_bias_exp_offset+16],
       _mem_bias_exp[_mem_bias_exp_offset+15],_mem_bias_exp[_mem_bias_exp_offset+14],_mem_bias_exp[_mem_bias_exp_offset+13],_mem_bias_exp[_mem_bias_exp_offset+12],
       _mem_bias_exp[_mem_bias_exp_offset+11],_mem_bias_exp[_mem_bias_exp_offset+10],_mem_bias_exp[_mem_bias_exp_offset+9],_mem_bias_exp[_mem_bias_exp_offset+8],
       _mem_bias_exp[_mem_bias_exp_offset+7],_mem_bias_exp[_mem_bias_exp_offset+6],_mem_bias_exp[_mem_bias_exp_offset+5],_mem_bias_exp[_mem_bias_exp_offset+4],
       _mem_bias_exp[_mem_bias_exp_offset+3],_mem_bias_exp[_mem_bias_exp_offset+2],_mem_bias_exp[_mem_bias_exp_offset+1],_mem_bias_exp[_mem_bias_exp_offset+0]} <= mem_bias_exp_i;
...
//    _mem_bias_exp[_mem_bias_exp_offset + 63] <= mem_bias_exp_i[(63+1)*(EXP_WIDTH+1)-1 : 63*(EXP_WIDTH+1)];
  ...
  reg  [9:0]       _mem_bias_offset_reg;
  reg              _mem_bias_valid_reg;
//  reg  [511:0]     _mem_bias_i_reg;
//  wire [MID_WIDTH*32-1:0]    _mem_bias_fixed_pre;
  wire [MID_WIDTH*32-1:0]    _mem_bias_fixed;
  reg  [9:0]       _mem_bias_fixed_offset;
  reg              _mem_bias_fixed_valid;
  always@(posedge clk or negedge rst_n) begin
    if(!rst_n) begin
      _mem_bias_valid_reg <= 1'b0;
      _mem_bias_fixed_valid <= 1'b0;
    end else begin
      _mem_bias_valid_reg <= mem_bias_valid;
      _mem_bias_fixed_valid <= _mem_bias_valid_reg;
    end
  end
  always@(posedge clk) begin
    _mem_bias_offset_reg <= _mem_bias_offset;
    _mem_bias_fixed_offset <= _mem_bias_offset_reg;
//    _mem_bias_i_reg <= mem_bias_i;
//    _mem_bias_fixed <= _mem_bias_fixed_pre;
  end
...
//      .dataout_valid(),
      .dataout(_mem_bias_fixed[(i+1)*MID_WIDTH-1:i*MID_WIDTH])
    );
    end
  endgenerate 
  ...
  always@(posedge clk) begin
    if(_mem_bias_fixed_valid) begin
      {_mem_bias[_mem_bias_fixed_offset+31],_mem_bias[_mem_bias_fixed_offset+30],_mem_bias[_mem_bias_fixed_offset+29],_mem_bias[_mem_bias_fixed_offset+28],
       _mem_bias[_mem_bias_fixed_offset+27],_mem_bias[_mem_bias_fixed_offset+26],_mem_bias[_mem_bias_fixed_offset+25],_mem_bias[_mem_bias_fixed_offset+24],
       _mem_bias[_mem_bias_fixed_offset+23],_mem_bias[_mem_bias_fixed_offset+22],_mem_bias[_mem_bias_fixed_offset+21],_mem_bias[_mem_bias_fixed_offset+20],
       _mem_bias[_mem_bias_fixed_offset+19],_mem_bias[_mem_bias_fixed_offset+18],_mem_bias[_mem_bias_fixed_offset+17],_mem_bias[_mem_bias_fixed_offset+16],
       _mem_bias[_mem_bias_fixed_offset+15],_mem_bias[_mem_bias_fixed_offset+14],_mem_bias[_mem_bias_fixed_offset+13],_mem_bias[_mem_bias_fixed_offset+12],
       _mem_bias[_mem_bias_fixed_offset+11],_mem_bias[_mem_bias_fixed_offset+10],_mem_bias[_mem_bias_fixed_offset+9],_mem_bias[_mem_bias_fixed_offset+8],
       _mem_bias[_mem_bias_fixed_offset+7],_mem_bias[_mem_bias_fixed_offset+6],_mem_bias[_mem_bias_fixed_offset+5],_mem_bias[_mem_bias_fixed_offset+4],
       _mem_bias[_mem_bias_fixed_offset+3],_mem_bias[_mem_bias_fixed_offset+2],_mem_bias[_mem_bias_fixed_offset+1],_mem_bias[_mem_bias_fixed_offset+0]} <= _mem_bias_fixed;
...
//  always@(posedge clk or negedge rst_n) begin
//    if(!rst_n) begin
//      _mem_data_wr_data_ready <= 1'b0;
//      mem_data_wr_data_valid <= 1'b0;
//    end else begin
...
//  end
  ...
  reg  [EXP_WIDTH:0]  _mem_bias_exp_cur_2;
  reg  [EXP_WIDTH:0]  _mem_bias_exp_cur_3;
//  reg  [EXP_WIDTH:0]  _mem_bias_exp_cur_4;
//  reg  [7*7*MID_WIDTH-1:0]  _mem_data_data_reg;
//  wire [7*7*FP_WIDTH-1:0]   _mem_data_data_pre;
//  wire [7*7*EXP_WIDTH-1:0]  _mem_data_data_exp_pre;
  assign _mem_bias_exp_idx = ({{6{1'b0}}, _mem_data_ker_set}<<6) + {{3{1'b0}}, _mem_data_channel_idx};
  always@(posedge clk) begin
    _mem_bias_exp_cur   <= _mem_bias_exp[_mem_bias_exp_idx];
    _mem_bias_exp_cur_1 <= _mem_bias_exp_cur;
    _mem_bias_exp_cur_2 <= _mem_bias_exp_cur_1;
    _mem_bias_exp_cur_3 <= _mem_bias_exp_cur_2;
//    _mem_bias_exp_cur_4 <= _mem_bias_exp_cur_3;
//    _mem_data_data_reg  <= _mem_data_data;
//    _mem_data_data_exp  <= _mem_data_data_exp_pre;
//    mem_data_data       <= _mem_data_data_pre;
  end
  genvar j;
  generate
    for(j=0; j<7*7; j=j+1)
...
//        .datain_valid(_mem_data_wr_data_valid_rising_edge),
        .exp_bias(_mem_bias_exp_cur_3), //exp_bottom+exp_ker, with and offset of 30, and is controlled by wr_ddr_data.v 
//        .dataout_valid(),                                                    
  ...
  assign _last_layer_valid      = _mem_data_pooling_we && (mem_data_conv_y[0]==1'b1);
...
//  reg                      _last_layer_reg;
  reg                      _last_layer_valid_reg;
  reg                      _last_layer_last_pos_reg;
  reg                      _last_layer_first_pos_reg;
  reg [3:0]                _last_layer_ker_set_reg;
  reg                      _last_layer_pooling_we_reg;
  //register for two clk
//  reg                      _last_layer_reg2;
  reg                      _last_layer_valid_reg2;
  reg                      _last_layer_last_pos_reg2;
  reg                      _last_layer_first_pos_reg2;
  reg [3:0]                _last_layer_ker_set_reg2;
  reg                      _last_layer_pooling_we_reg2;
  
  always@(posedge clk) begin
//    _last_layer_reg           <= mem_data_last_layer;
    _last_layer_valid_reg     <= _last_layer_valid;
    ...
    _last_layer_pooling_we_reg<= _mem_data_pooling_we;
  end
  always@(posedge clk) begin
//    _last_layer_reg2           <= _last_layer_reg;
    _last_layer_valid_reg2     <= _last_layer_valid_reg;
    _last_layer_last_pos_reg2  <= _last_layer_last_pos_reg; 
    _last_layer_first_pos_reg2 <= _last_layer_first_pos_reg;
    _last_layer_ker_set_reg2   <= _last_layer_ker_set_reg;
    _last_layer_pooling_we_reg2<= _last_layer_pooling_we_reg;
  end
      
  always@(posedge clk) begin
//    if(_last_layer_reg2) begin
    if(mem_data_last_layer) begin
      mem_data_last_layer_valid   <= _last_layer_valid_reg2;
      mem_data_last_layer_last_pos<= _last_layer_last_pos_reg2;
      mem_data_last_layer_ker_set <= _last_layer_ker_set_reg2;
      mem_data_last_layer_on      <= 1'b1;
      mem_data_last_layer_first_pos <= _last_layer_first_pos_reg2;
//      if(_last_layer_pooling_we_reg2) begin
...
//      mem_data_conv_data_last_layer_o <= {(FP_WIDTH*K_C){1'b0}};
  ...
  wire [K_C*FP_WIDTH-1:0]      _last_layer_o_pre;
  genvar k;
  generate
    for(k=0; k<K_C; k=k+1)
    begin:wr_fc
...
//        .datain_valid(_last_layer_fixed_valid),
        .exp_bias(_mem_bias_exp[_mem_data_cur_ker_set + k]), //exp_bottom+exp_ker, with and offset of 30, 
