...
#define kerWidth        3
#define kerHeight       3
#define channels   64  // number of bottom channels // <-x
#define biasNUM    128 // number of top channels
#define biasMax    512
#define epsilonError  12.0 // 5_3 -> 8.0, 4-3 -> 14.0, 4_1 -> 32.0, 3_3 -> 32.0, 3_2 -> 16.0, 3_1 -> 16.0, 2_2 -> 16.0, 2_1 -> 12.0, 1_2 -> 4.0 , 1_1 -> 4.0
#define relativeError 0.15 // 5_3 -> 0.2, 4-3 -> 0.15, 4_1 -> 0.25, 3_3 -> 0.25, 3_2 -> 0.25, 3_1 -> 0.25, 2_2 -> 0.25, 2_1 -> 0.15, 1_2 -> 0.1 , 1_1 -> 0.1
#define absError      2.3 // 5_3 -> 2.0, 4-3 -> 3.6 , 4_1 -> 6.8 , 3_3 -> 6.8 , 3_2 -> 4.7 , 3_1 -> 4.7 , 2_2 -> 4.7 , 2_1 -> 2.3 , 1_2 -> 0.45, 1_1 -> 0.4
